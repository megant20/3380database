...
<body style="background-color: #004528;">
	...
	<?php
		...
		$sql = "SELECT * FROM user WHERE user_name='$_SESSION[login_user]'";
	...
	<?php 
		...
		if(isset($_POST['submit']))
		{
			...
			$sql1= "UPDATE user SET pic='$pic', first='$first', last='$last', user_name='$user_name', password='$password', email='$email', phone_number='$phone_number' WHERE user_name='".$_SESSION['login_user']."';";
