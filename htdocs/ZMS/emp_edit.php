...
<body style="background-color: #004528;">
	...
	<?php 
		...
		if(isset($_POST['submit']))
		{
			...
			$sql1= "UPDATE employee SET pic='$pic', first='$first', last='$last', username='$username', password='$password', email='$email', phone_number='$phone_number' WHERE username='".$_SESSION['login_user']."';";
